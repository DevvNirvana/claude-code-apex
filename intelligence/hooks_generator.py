...
def build_session_start_script(constraints: list[dict]) -> str:
    ...
    lines = [
        "#!/usr/bin/env bash",
        "# APEX SessionStart Hook — re-injects critical constraints after context compaction",
        "# Without this, CLAUDE.md rules vanish after compaction. With this, they survive.",
        "echo ''",
    ]
    if banner_cmd:
...
def main():
    ...
    scripts = {
        ...
        "crash-checkpoint.sh": _load_template_hook("crash-checkpoint.sh"),
    }
    if lint:
